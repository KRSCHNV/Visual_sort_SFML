...
int main(int, char const**)
{
    ...
    radio_button bubble_sort_rb, selection_sort_rb, insertion_sort_rb, quick_sort_rb, merge_sort_rb, heap_sort_rb;
    ...
    radio_button radio_button_arr[6] = {bubble_sort_rb, selection_sort_rb, insertion_sort_rb, quick_sort_rb, merge_sort_rb, heap_sort_rb};
    radio_button_arr[0].checked = true;
    bool radio_button_flag = false;
    
    //Инициализация массива
    elem array[512], old_array[512];
